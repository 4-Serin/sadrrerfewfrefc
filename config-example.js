module.exports = {
    ...
    Discord: {
        ...
        token: "MTA2NDE4MTQ1OTkzMTM4MTc2MA.GisO7H.2D5traRGgZ58GEzItndkMlwwC5fE0ehNLUFKUg", // —— Your bot's token.
        botId: "1064181459931381760", // —— The bot's ID.
        guildId: "1061329345488113704", // —— The server ID on where the commands will be deployed.
        verifiedRole: "인증됨", // —— Role that will be added to the user when they verify their account.
